package com.locser.twitter.config;
...
public class MailConfiguration {
    ...
    private static final String APPLICATION_NAME = "gmailtesttwitter";
    ...
    private Credential getCredential (final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        ...
        if (in ==null){
            throw  new FileNotFoundException("Credentials files not found!");
        }
